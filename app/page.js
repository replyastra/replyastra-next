        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-10 text-left relative transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl hover:border hover:border-emerald-200 group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Set Rules</h3>
              <p className="text-gray-600 leading-relaxed">
  ...
  return (
    <div className="max-w-6xl mx-auto text-center">
      ...
      <div className="mt-8 flex items-center justify-center gap-3 text-sm font-semibold">
        <span className={!yearly ? "text-gray-900" : "text-gray-400"}>Monthly</span>
        ...
        <span className={yearly ? "text-gray-900" : "text-gray-400"}>Yearly</span>
