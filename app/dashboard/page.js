...
function Topbar({ page, user, setOpen, lang, planType }) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 lg:px-10 py-4">
      ...
      <h1 className="serif text-3xl sm:text-7xl text-gray-900 font-normal italic tracking-tight">
    ...
    <div className="p-6 lg:p-10 space-y-8 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={label} className="bg-white border border-gray-200 rounded-3xl p-5 lg:p-6 shadow-sm min-h-[138px]">
            <div className="flex justify-between items-start mb-3">
              <div className="h-7 w-7 rounded-lg border border-gray-200 bg-gray-50" />
              <span className="text-[10px] px-2 py-0.5 rounded-full font-semibold text-gray-500 bg-gray-100">{change}</span>
            </div>
            <div className="text-[10px] text-gray-400 uppercase tracking-[0.2em] font-semibold mb-1">{label}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-1">
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-3xl p-6 lg:p-7 shadow-sm">
          <div className="mb-6">
            <div className="serif text-4xl italic text-gray-900 mb-1">{t.engagementVolume}</div>
            <div className="text-[10px] text-gray-400 uppercase tracking-[0.2em]">Last 7 days activity</div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-6 lg:p-7 shadow-sm">
          <div className="mb-6">
            <div className="serif text-3xl italic text-gray-900 mb-1">{t.conversionSources}</div>
          </div>
