...
const TRANSLATIONS = {
  en: {
    welcome: "Welcome", overview: "Overview", automations: "Automations", contacts: "Contacts",
    ai: "ReplyAstra AI", settings: "Settings", logout: "Logout", usage: "Usage",
    sentReplies: "Sent Replies", automationHits: "Automation Hits", conversion: "Conversion",
    leads: "Contacts", engagementVolume: "Engagement Volume", conversionSources: "Conversion Sources",
    storyReply: "Story Reply", commentDM: "Comment DM", profile: "Profile", security: "Security",
    instagramAccounts: "Instagram Accounts", billing: "Billing", language: "Language",
    currentPlan: "Current Plan", upgradePlan: "Upgrade", cancelSubscription: "Cancel subscription",
    monthlyDMs: "monthly DMs", search: "Search", leadManagement: "Lead Management",
  },
  kn: {
    welcome: "ಸ್ವಾಗತ", overview: "ಅವಲೋಕನ", automations: "ಸ್ವಯಂಚಾಲನೆಗಳು", contacts: "ಸಂಪರ್ಕಗಳು",
    ai: "ರಿಪ್ಲೈಅಸ್ಟ್ರಾ AI", settings: "ಸೆಟ್ಟಿಂಗ್‌ಗಳು", logout: "ಲಾಗ್ಔಟ್", usage: "ಬಳಕೆ",
    sentReplies: "ಕಳುಹಿಸಿದ ಪ್ರತ್ಯುತ್ತರಗಳು", automationHits: "ಸ್ವಯಂಚಾಲನೆ ಹಿಟ್‌ಗಳು",
    conversion: "ಪರಿವರ್ತನೆ", leads: "ಸಂಪರ್ಕಗಳು", engagementVolume: "ತೊಡಗಿಸಿಕೊಳ್ಳುವಿಕೆಯ ಪ್ರಮಾಣ",
    conversionSources: "ಪರಿವರ್ತನೆಯ ಮೂಲಗಳು", storyReply: "ಸ್ಟೋರಿ ಪ್ರತ್ಯುತ್ತರ",
    commentDM: "ಕಾಮೆಂಟ್ DM", profile: "ಪ್ರೊಫೈಲ್", security: "ಸುರಕ್ಷತೆ",
    instagramAccounts: "ಇನ್‌ಸ್ಟಾಗ್ರಾಮ್ ಖಾತೆಗಳು", billing: "ಬಿಲ್ಲಿಂಗ್", language: "ಭಾಷೆ",
    currentPlan: "ಪ್ರಸ್ತುತ ಯೋಜನೆ", upgradePlan: "ನವೀಕರಿಸಿ", cancelSubscription: "ರದ್ದುಗೊಳಿಸಿ",
    monthlyDMs: "ಮಾಸಿಕ DM", search: "ಹುಡುಕಿ", leadManagement: "ಲೀಡ್ ನಿರ್ವಹಣೆ",
  },
};
...
const Icons = {
  ...
  ai: () => <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z"/></svg>,
  ...
  eye: () => <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>,
  eyeOff: () => <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.477 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>,
};
...
function Sidebar({ page, setPage, plan, monthlyDMs, open, setOpen, lang }) {
  ...
  const NAV = [
    ...
    { id: "contacts", label: t.contacts, Icon: Icons.contacts },
  ...
  const SidebarContent = () => (
    <>
      <div className="px-6 py-6 border-b border-gray-100">
        <img src="https://drive.google.com/uc?export=view&id=1CkhHHcGFCr6BmfoE2TylgYJRlJQkcDEC" alt="ReplyAstra" className="h-7 w-auto" />
      </div>
      <div className="px-4 pt-4 pb-2">
        <div className="relative">
          <input type="text" placeholder={`${t.search}...`} value={search} onChange={e => setSearch(e.target.value)} className="w-full pl-8 pr-3 py-1.5 text-xs border-0 bg-gray-50 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-200 text-gray-600 placeholder-gray-400" />
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex w-44 bg-white border-r border-gray-100 flex-col h-screen sticky top-0"><SidebarContent /></aside>
    </>
  );
}
...
function Topbar({ page, user, setOpen, lang }) {
  const t = TRANSLATIONS[lang] || TRANSLATIONS.en;
  const titles = { overview: t.welcome, automations: "Flows", contacts: t.leadManagement, ai: t.ai, settings: "Console", pricing: "Plans & Pricing" };
  ...
  useEffect(() => {
    async function load() {
      const [{ count: totalDMs }, { count: activeAutos }, { count: leads }, { count: success }] = await Promise.all([
        ...
        supabase.from("contacts").select("*", { count: "exact", head: true }).eq("owner_user_id", userId),
      ...
      const total = totalDMs || 1;
      setConversion([
        { label: t.storyReply, pct: 0, color: "bg-gray-900" },
        { label: t.commentDM, pct: 100, color: "bg-gray-600" },
      ]);
      setLoading(false);
    }
    load();
...
function AutomationsPage() { return <div className="p-8 text-center"><p className="serif text-2xl text-gray-400">Automations - Coming Soon</p></div>; }
function ContactsPage() { return <div className="p-8 text-center"><p className="serif text-2xl text-gray-400">Lead Management - Coming Soon</p></div>; }
function AIPage() { return <div className="p-8 text-center"><p className="serif text-2xl text-gray-400">ReplyAstra AI - Coming Soon</p></div>; }
function SettingsPage() { return <div className="p-8 text-center"><p className="serif text-2xl text-gray-400">Settings - Coming Soon</p></div>; }
function PricingPage() { return <div className="p-8 text-center"><p className="serif text-2xl text-gray-400">Pricing - Coming Soon</p></div>; }
